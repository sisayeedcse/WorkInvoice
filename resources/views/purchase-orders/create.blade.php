...
@section('content')
    <div class="page-header">
        <div>
            ...
            <p class="text-muted mb-0" style="font-size:13px;">Prepare supplier and subcontractor orders with clearer
                procurement totals and delivery context.</p>
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('purchase-orders.store') }}">
        ...
        <div class="row g-3">
            <div class="col-12 col-lg-4 sticky-summary">
                <div class="card mb-3">
                    <div class="card-header"><i class="bi bi-building me-2" style="color:var(--accent);"></i>Supplier
                        Details</div>
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" name="supplier_name"
                                ...
                                value="{{ old('supplier_name') }}" placeholder="Supplier / Contractor name" required>
                ...
                <div class="surface-note mt-3">
                    <strong>Procurement note</strong><br>
                    Keep supplier details and item quantities precise to reduce fulfillment and receiving errors.
                </div>
            </div>
            ...
            <div class="col-12 col-lg-8">
                <div class="card mb-3">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <span><i class="bi bi-list-ul me-2" style="color:var(--accent);"></i>Items to Purchase</span>
                        ...
                        <table class="table mb-0">
                            <thead>
                                <tr class="table-light">
                                    <th style="min-width:170px;">Item / Material</th>
                            ...
                            <tbody id="items-container">
                                <tr class="item-row" data-index="0">
                                    ...
                                    <td><input type="number" name="items[0][quantity]"
                                            class="form-control qty-input text-center" value="1" step="0.01" min="0.01"
                                            required></td>
                                    ...
                                    <td><input type="text" class="form-control total-input bg-light text-end fw-semibold"
                                            value="0.00" readonly></td>
                                    <td class="text-center"><span class="remove-row" onclick="removeRow(this)"><i
                                                class="bi bi-x-circle-fill text-danger"></i></span></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <textarea name="terms" class="form-control" rows="3">{{ old('terms', $terms) }}</textarea>
                        </div>
                    </div>
                </div>

                <div class="d-flex gap-2 mt-3">
                    <button type="submit" class="btn btn-accent px-4"><i class="bi bi-check-lg me-1"></i>Save Purchase
                        Order</button>
...
@push('scripts')
    <script>
        ...
        function addRow() {
            ...
            tr.innerHTML = `<td><input type="text" name="items[${rowIndex}][item_name]" class="form-control item-name-input" placeholder="Material or item" required></td>
        ...
        function calc() {
            ...
            const tx = parseFloat(document.getElementById('tax')?.value) || 0;
            const afterDisc = Math.max(0, s - disc);
            const gt = afterDisc + (afterDisc * tx / 100);
