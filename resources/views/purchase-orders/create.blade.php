...
<div class="row g-3">
    <div class="col-12 col-lg-4">
        <div class="card mb-3">
            <div class="card-header"><i class="bi bi-building me-2" style="color:var(--accent);"></i>Supplier Details</div>
            <div class="card-body">
                <div class="mb-3">
                ...
                <div>
                    ...
                    <textarea name="supplier_address" class="form-control" rows="2">{{ old('supplier_address') }}</textarea>
                </div>
            </div>
        </div>
    ...
    <div class="col-12 col-lg-8">
                ...
                <table class="table mb-0">
                    ...
                    <tbody id="items-container">
                        <tr class="item-row" data-index="0">
                            <td><input type="text" name="items[0][item_name]" class="form-control item-name-input" placeholder="Material or item" required></td>
                            ...
                            <td><select name="items[0][unit]" class="form-select">
                                @foreach(['Unit','Piece','Meter','Sqm','Kg','Set','Lot','Hour','Day','Job'] as $u)<option>{{ $u }}</option>@endforeach
                            </select></td>
        ...
        <div class="d-flex gap-2 mt-3">
            <button type="submit" class="btn btn-accent px-4"><i class="bi bi-check-lg me-1"></i>Save Purchase Order</button>
