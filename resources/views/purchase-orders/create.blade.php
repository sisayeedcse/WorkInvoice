...
@push('styles')
    <style>
        ...
        .qf-input-wrap textarea.form-control {
            padding-left: 36px;
        }
...
@section('content')
    ...
    <div class="qf-hero">
        <div class="qf-hero-left">
            <div class="qf-hero-badge mb-2">
                <i class="bi bi-clipboard2-check"></i> New Purchase Order
            </div>
            <h1>Create Purchase Order</h1>
            <p>Capture supplier details, delivery timeline, and item lines to prepare procurement clearly.</p>
        </div>
        <div class="qf-hero-steps d-none d-lg-flex">
            <div class="qf-step active">
                <div class="qf-step-num">1</div><span>Supplier</span>
            </div>
    ...
    <div class="qf-tip">
        ...
        <div><strong>Workflow tip:</strong> Keep supplier contact and delivery date accurate to improve receiving and
            follow-up communication.</div>
    </div>
        ...
        <div class="qf-section">
            <div class="qf-section-header">
                <div class="qf-section-title">
                    <div class="qf-section-icon"><i class="bi bi-building"></i></div>
                    Supplier Details
                </div>
            ...
            <div class="qf-section-body">
                <div class="row g-4">
                    <div class="col-12 col-lg-6">
                        <label class="qf-label">Supplier Name <span class="req">*</span></label>
                        <div class="qf-input-wrap">
                            <i class="bi bi-person-vcard qf-input-icon"></i>
                            <input type="text" name="supplier_name"
                                class="form-control @error('supplier_name') is-invalid @enderror"
                                value="{{ old('supplier_name') }}" placeholder="Supplier / Contractor name" required>
                        </div>
                        @error('supplier_name')<div class="invalid-feedback d-block mt-1">{{ $message }}</div>@enderror
                    </div>
                    <div class="col-12 col-md-6 col-lg-3">
                        <label class="qf-label">Phone</label>
                        <div class="qf-input-wrap">
                            <i class="bi bi-telephone qf-input-icon"></i>
                    ...
                    <div class="col-12 col-md-6 col-lg-3">
                        ...
                        <div class="qf-input-wrap">
                            <i class="bi bi-envelope qf-input-icon"></i>
            ...
            <div class="qf-section-body">
                <div class="qf-details-grid">
                    ...
                    <div>
                        ...
                        <div class="qf-input-wrap">
                            <i class="bi bi-truck qf-input-icon"></i>
        ...
        <div class="qf-section">
            ...
            <div class="qf-actions">
                <button type="submit" class="btn-qf-save">
                    <i class="bi bi-check2-circle"></i> Save Purchase Order
                </button>
                <a href="{{ route('purchase-orders.index') }}" class="btn-qf-cancel">
