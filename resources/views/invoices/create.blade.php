...
<div class="row g-3">
    ...
    <div class="col-12 col-lg-8">
                ...
                <table class="table mb-0">
                    ...
                    <tbody id="items-container">
                        <tr class="item-row" data-index="0">
                            ...
                            <td><select name="items[0][unit]" class="form-select">@foreach(['Unit','Piece','Meter','Sqm','Kg','Set','Lot','Hour','Day','Job'] as $u)<option>{{ $u }}</option>@endforeach</select></td>
        ...
        <div class="d-flex gap-2 mt-3">
            <button type="submit" class="btn btn-accent px-4"><i class="bi bi-check-lg me-1"></i>Save Invoice</button>
