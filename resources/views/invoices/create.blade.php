...
@section('content')
    <div class="page-header">
        <div>
            ...
            <p class="text-muted mb-0" style="font-size:13px;">Generate a clean billing document with due dates, terms, and
                itemized totals.</p>
        </div>
    </div>
        ...
        <div class="row g-3">
            <div class="col-12 col-lg-4 sticky-summary">
                ...
                <div class="surface-note mt-3">
                    ...
                    Confirm due date, terms, and amounts before sharing the invoice or recording partial payments later.
                </div>
            </div>
                            ...
                            <tbody id="items-container">
                                <tr class="item-row" data-index="0">
                                    ...
                                    <td><input type="number" name="items[0][quantity]"
                                            ...
                                            required></td>
                                    <td><select name="items[0][unit]"
                                            class="form-select">@foreach(['Unit', 'Piece', 'Meter', 'Sqm', 'Kg', 'Set', 'Lot', 'Hour', 'Day', 'Job'] as $u)
                                            <option>{{ $u }}</option>@endforeach</select></td>
...
@push('scripts')
    <script>
        ...
        function removeRow(btn) { if (document.querySelectorAll('.item-row').length <= 1) { alert('At least one item required.'); return; } btn.closest('tr').remove(); calc(); }
        ...
        document.getElementById('tax')?.addEventListener('input', calc); calc();
    </script>
@endpush