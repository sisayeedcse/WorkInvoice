            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-1" style="font-size:12px;">
                    ...
                    <li class="breadcrumb-item"><a
                            href="{{ route('quotations.show', $quotation) }}">{{ $quotation->quotation_number }}</a></li>
    ...
    <form method="POST" action="{{ route('quotations.update', $quotation) }}" id="quoteForm">
        ...
        <div class="row g-3">
            ...
            <div class="col-12 col-lg-4">
                ...
                <div class="card mb-3">
                    <div class="card-header"><i class="bi bi-calendar me-2" style="color:var(--accent);"></i>Dates & Status
                    </div>
                    <div class="card-body">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="prepared_by" class="form-control"
                                ...
                                placeholder="Name of quotation maker">
                        </div>
                        <div>
                                ...
                                @foreach(old('items') ? [] : $quotation->items as $i => $item)
                                    <tr class="item-row" data-index="{{ $i }}">
                                        <td><input type="text" name="items[{{ $i }}][item_name]"
                                                class="form-control item-name-input" value="{{ $item->item_name }}" required>
                                        </td>
                                        ...
                                        <td><input type="number" name="items[{{ $i }}][unit_price]"
                                                class="form-control price-input" value="{{ $item->unit_price }}" step="0.01"
                                                min="0" required></td>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <textarea name="notes" class="form-control"
                                rows="2">{{ old('notes', $quotation->notes) }}</textarea>
                        </div>
                        <div>
