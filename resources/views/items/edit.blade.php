...
<div class="row justify-content-center">
    <div class="col-12 col-lg-7">
        <div class="card">
            <div class="card-header"><i class="bi bi-pencil-square me-2" style="color:var(--accent);"></i>Service Details</div>
            <div class="card-body">
                <form method="POST" action="{{ route('items.update', $item) }}">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <input type="number" name="default_price" step="0.01" min="0"
                                   class="form-control" value="{{ old('default_price', $item->default_price) }}" required>
                        </div>
                        <div class="col-12 col-sm-6">
                    ...
                    <div class="d-flex gap-2 mt-4">
                        <button type="submit" class="btn btn-accent px-4"><i class="bi bi-check-lg me-1"></i>Update Service</button>
