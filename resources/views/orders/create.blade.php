...
@section('content')
    <div class="page-header">
        <div>
            ...
            <p class="text-muted mb-0" style="font-size:13px;">Capture approved work with delivery expectations and a clean
                production-ready item list.</p>
        </div>
    </div>
        ...
        <div class="row g-3">
            <div class="col-12 col-lg-4 sticky-summary">
                ...
                <div class="surface-note mt-3">
                    ...
                    Use delivery information and item descriptions to make handoff to workshop operations clearer.
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <textarea name="delivery_info" class="form-control" rows="2"
                                placeholder="Delivery instructions...">{{ old('delivery_info') }}</textarea>
                        </div>
                    </div>
                </div>
